...
export const metadata = { title: "Get Started | Consult6" };
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div className="auth-card" style={{ background: "#333333", border: "1px solid #484848", borderRadius: 12 }}>
          <button onClick={handleGoogleSignup} disabled={googleLoading || loading} style={{ width: "100%", background: "#fff", color: "#272727", border: "1px solid #5a5a5a", borderRadius: 8, padding: "11px 0", fontSize: 14, fontWeight: 600, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, cursor: "pointer", opacity: googleLoading ? 0.7 : 1, marginBottom: 20 }}>
          ...
          <button onClick={handleSignup} disabled={loading || googleLoading} style={{ width: "100%", background: "#CC5500", color: "#fff", border: "none", borderRadius: 8, padding: "12px 0", fontSize: 15, fontWeight: 600, opacity: loading ? 0.7 : 1 }}>
