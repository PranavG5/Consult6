  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <form onSubmit={handleSignup} className="auth-card" style={{ background: "#333333", border: "1px solid #484848", borderRadius: 12 }}>
          <button type="button" onClick={handleGoogleSignup} disabled={googleLoading || loading} style={{ width: "100%", background: "#fff", color: "#272727", border: "1px solid #5a5a5a", borderRadius: 8, padding: "11px 0", fontSize: 14, fontWeight: 600, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, cursor: "pointer", opacity: googleLoading ? 0.7 : 1, marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
            ...
            <span style={{ fontSize: 12, color: "#555" }}>or sign up with email</span>
            <div style={{ flex: 1, height: 1, background: "#484848" }} />
          </div>
          <div style={{ marginBottom: 16 }}>
            <label htmlFor="signup-email" style={{ display: "block", fontSize: 13, color: "#aaa", marginBottom: 6 }}>Email</label>
            <input id="signup-email" required value={email} onChange={e => setEmail(e.target.value)} type="email" placeholder="you@example.com" />
          </div>
          <div style={{ marginBottom: 20 }}>
            <label htmlFor="signup-password" style={{ display: "block", fontSize: 13, color: "#aaa", marginBottom: 6 }}>Password</label>
            <input id="signup-password" required minLength={6} value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="At least 6 characters" />
          </div>
          ...
          <button type="submit" disabled={loading || googleLoading} style={{ width: "100%", background: "#CC5500", color: "#fff", border: "none", borderRadius: 8, padding: "12px 0", fontSize: 15, fontWeight: 600, opacity: loading ? 0.7 : 1 }}>
