  ...
  return (
    <div style={{ minHeight: "100vh", background: "#1e1e1e", color: "#f0f0f0", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <main className="legal-main">
        ...
        <p style={{ fontSize: 15, color: "#888", lineHeight: 1.8, margin: "0 0 12px" }}>
          The analysis output produced by Consult6 is generated by artificial intelligence (Anthropic&apos;s Claude models) based on the data you provide and the context you specify. To produce a report, the contents of your uploaded file and your context are sent to Anthropic&apos;s API for processing. By using the service, you consent to this processing.
        </p>
        <p style={{ fontSize: 15, color: "#888", lineHeight: 1.8, margin: "0 0 12px" }}>
          AI-generated output is intended to support your decision-making, not replace professional financial judgement. Because it is produced by an automated model, it may contain errors, omissions, or inaccuracies. The insights, flags, recommendations, and projections should be treated as a starting point for review, not as audited or certified financial advice.
        </p>
        <p style={{ fontSize: 15, color: "#888", lineHeight: 1.8, margin: "0 0 32px" }}>
        ...
        <p style={{ fontSize: 15, color: "#888", lineHeight: 1.8, margin: "0 0 32px" }}>
          Consult6 lets you create a shareable link to a report. Anyone with that link can view the report without signing in until you revoke it. You are responsible for who you share these links with and for the financial information they contain. You can revoke a share link at any time from your report history.
        </p>
